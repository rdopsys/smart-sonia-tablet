...
public class AccidentsCalendarAdapter extends RecyclerView.Adapter<AccidentsCalendarAdapter.ViewHolder> {

    private ArrayList<AccidentObject> data;
    private HandleEventClick clickListener;


    public AccidentsCalendarAdapter(ArrayList<AccidentObject> data, HandleEventClick clickListener){
        this.data = data;
