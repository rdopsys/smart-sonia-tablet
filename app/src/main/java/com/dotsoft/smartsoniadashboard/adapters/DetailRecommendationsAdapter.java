...
public class DetailRecommendationsAdapter extends RecyclerView.Adapter<DetailRecommendationsAdapter.ViewHolder> {

    private ArrayList<RecommendationObject> data;

    public DetailRecommendationsAdapter(ArrayList<RecommendationObject> data){
        this.data = data;
    }
    ...
    public void addData(RecommendationObject item){
